...
The current JUnit suite has **63.5% line coverage (250 of 394 executable lines)**, measured on 2026-08-27 with JaCoCo by running `./gradlew clean test jacocoTestReport` on Java 25. The HTML report is generated at `build/reports/jacoco/test/html/index.html`.

...
The current JUnit suite has **72.3% line coverage (345 of 477 executable lines)**, measured on 2026-09-10 with JaCoCo by running `./gradlew clean test jacocoTestReport` on Java 25. The HTML report is generated at `build/reports/jacoco/test/html/index.html`.
